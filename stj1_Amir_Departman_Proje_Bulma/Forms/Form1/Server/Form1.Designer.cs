...
namespace stj1_Amir_Departman_Proje_Bulma.Forms {
    ...
    public partial class Form1 : Form<E_stj1_Amir_Departman_Proje_Bulma_Form1Entity> {

        // properties
        DataGrid DataGrid1 { get; set; }
Radio RdDurum { get; set; }
NumberBox NbSayi { get; set; }
ComboBox CbAmir { get; set; }
ComboBox CbPersonel { get; set; }
TextBox TxtAciklama { get; set; }
...
EntityPath = "E_stj1_Amir_Departman_Proje_Bulma_Form1_DataGrid1",
ReadOnly = false,
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "RdDurum" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Controls.Add(RdDurum);

BaseComponent default_rddurumComponent = new BaseComponent {
Id = "RdDurum",
Type = "Radio",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
AddToViewItems("default", default_rddurumComponent);
...
Name = "Form1";
FormId = "47d254b6-2ec2-4a91-9ed4-55da81a01b6a";
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "NbSayi" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
BaseComponent default_nbsayiComponent = new BaseComponent {
Id = "NbSayi",
Type = "NumberBox",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
AddToViewItems("default", default_nbsayiComponent);
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "CbAmir" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Controls.Add(CbAmir);
CbAmir.Items = new ListItemCollection();

BaseComponent default_cbamirComponent = new BaseComponent {
Id = "CbAmir",
Type = "ComboBox",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
AddToViewItems("default", default_cbamirComponent);
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "CbPersonel" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Controls.Add(CbPersonel);
CbPersonel.Items = new ListItemCollection();

BaseComponent default_cbpersonelComponent = new BaseComponent {
Id = "CbPersonel",
Type = "ComboBox",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
Properties = CbPersonel,
ViewProperties = "",
};

AddToViewItems("default", default_cbpersonelComponent);
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "TxtAciklama" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
BaseComponent default_txtaciklamaComponent = new BaseComponent {
Id = "TxtAciklama",
Type = "TextBox",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
Properties = TxtAciklama,
ViewProperties = "",
};

AddToViewItems("default", default_txtaciklamaComponent);
