...
namespace stj1_Amir_Departman_Proje_Bulma.Forms {
    ...
    public partial class Form2 : Form<E_stj1_Amir_Departman_Proje_Bulma_Form2Entity> {

        // properties
        ComboBox CbDepartment { get; set; }
ComboBox CbSubDepartments { get; set; }
TextBox TxtDetay { get; set; }
DataGrid ModalDataGrid1 { get; set; }
...
ProjectId = "41e2860b-b80e-4e14-a15a-61d0f80fcf30";
EntityPath = "";
ActiveView = "default";
Version = 10;
ReadOnly = false;
...
Name = "Form2";
FormId = "d46e9fee-413b-4123-9bef-99a66aed9dc6";
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "CbDepartment" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
CbDepartment.Items = new ListItemCollection();

BaseComponent default_cbdepartmentComponent = new BaseComponent {
Id = "CbDepartment",
Type = "ComboBox",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
Properties = CbDepartment,
ViewProperties = "",
};

AddToViewItems("default", default_cbdepartmentComponent);

CbSubDepartments = new ComboBox {
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "CbSubDepartments" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
EntityPath = "SL.CbSubDepartments",
ReadOnly = false,
DefaultReadOnly = false,
Indexable = false,
TabIndex = 0,
...
Controls.Add(CbSubDepartments);
CbSubDepartments.Items = new ListItemCollection();

BaseComponent default_cbsubdepartmentsComponent = new BaseComponent {
Id = "CbSubDepartments",
Type = "ComboBox",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
Properties = CbSubDepartments,
ViewProperties = "",
};

AddToViewItems("default", default_cbsubdepartmentsComponent);
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "TxtDetay" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
BaseComponent default_txtdetayComponent = new BaseComponent {
Id = "TxtDetay",
Type = "TextBox",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
AddToViewItems("default", default_txtdetayComponent);

ModalDataGrid1 = new DataGrid {
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "ModalDataGrid1" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
EntityPath = "E_stj1_Amir_Departman_Proje_Bulma_Form2_ModalDataGrid1",
ReadOnly = false,
DefaultReadOnly = false,
Indexable = false,
...
Controls.Add(ModalDataGrid1);

BaseComponent default_modaldatagrid1Component = new BaseComponent {
Id = "ModalDataGrid1",
Type = "DataGrid",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
Properties = ModalDataGrid1,
ViewProperties = "",
};

AddToViewItems("default", default_modaldatagrid1Component);
